<template>
    <div id="app">
        ...
        <div style="display: flex; align-items: center;">
            ...
            <h1 class="custom-heading" style="font-size: 3rem;">어도비하우스</h1>&nbsp;
            <h2 style="color: orange; margin-right: 5px; font-size: 1.5rem;">4.7</h2>&nbsp;
            <div style="background-color: red; color: white; padding: 4px; border-radius: 5px;">HOT</div>
        </div>
        <h3 style="color: #888888;">참나무 캠프파이어가 가능한 카페</h3>
        <div style="display: flex; align-items: center;">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3ASXjGIo986PggHToAPpmwuyk9bO2eIsgpQ&usqp=CAU"
                style="width: 20px; height: 20px; margin-right: 5px;">
            <p class="custom-heading" style="font-size: 12px; margin-bottom: 0;">3859</p>&nbsp;&nbsp;
            ...
            <v-col>
                <div class="content-box">
                    ...
                    <p style="text-align: justify; text-justify: inter-word; font-size: 16px;">
                        대흥동 분위기 좋은 예쁜 카페 어도비하우스입니다.
                        2층짜리 주택을 개조해서 만든 까페로 규모가 꽤 크며 방마다 아늑한 분위기를 자아냅니다.
                        맛이 좋은 커피 외에도 다양한 음료메뉴들과 디저트 메뉴들이 준비되어 있습니다.
                    </p>
                </div>
            </v-col>
            <v-col>
                <div class="content-box"><br>
                    <h3>　영업시간　　<span class="light-text">매일12:30 ~ 22:00</span></h3><br>
                    <h3>　주소　　　　
                        <span class="light-text">대전광역시 중구 대흥로169번길 15</span>
                    </h3><br>
                    <div style="display: flex; align-items: center;">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <div
                        ...
                        <h5 style="display: inline-block; margin-left: 5px; color: grey;">대전광역시 중구 대흥동 93-1</h5>
                    </div><br>
                    <h3>　전화번호　　<span class="light-text"></span></h3><br>
                </div>
            </v-col>
        </v-row>
    </div>
...
export default {
    data() {
        return {
            ...
            current: 0,
            imageSources: [
                "https://img.siksinhot.com/place/1521170663882294.jpg?w=307&h=300&c=Y",
                "https://img.siksinhot.com/story/1532480566127226.jpg?w=307&h=300&c=Y",
                "https://img.siksinhot.com/story/1528917453821159.jpg?w=307&h=300&c=Y",
                "https://img.siksinhot.com/story/1532480566600227.jpg?w=307&h=300&c=Y"
            ]
        };
    },
    mounted() {
