<template>
    <div id="app">
        ...
        <div style="display: flex; align-items: center;">
            ...
            <h1 class="custom-heading" style="font-size: 3rem;">왕관식당</h1>&nbsp;
            <h2 style="color: orange; margin-right: 5px; font-size: 1.5rem;">4.3</h2>&nbsp;
            <div style="background-color: red; color: white; padding: 4px; border-radius: 5px;">HOT</div>
        </div>
        <h3 style="color: #888888;">비빔밥 달인이 운영하는 한식당</h3>
        <div style="display: flex; align-items: center;">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3ASXjGIo986PggHToAPpmwuyk9bO2eIsgpQ&usqp=CAU"
                style="width: 20px; height: 20px; margin-right: 5px;">
            <p class="custom-heading" style="font-size: 12px; margin-bottom: 0;">38464</p>&nbsp;&nbsp;
            <img src="data:image/png;base64,"
                style="width: 20px; height: 20px; margin-right: 5px;">
            <p class="custom-heading" style="font-size: 12px; margin-bottom: 0;">99</p>&nbsp;&nbsp;
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYojtp98XI0qyv4sKILEgHfAg1E1D4g8ZP1Q&usqp=CAU"
                style="width: 20px; height: 20px; margin-right: 5px;">
            <p class="custom-heading" style="font-size: 12px; margin-bottom: 0;">63</p>&nbsp;&nbsp;
        </div>
        <h3>
            ...
            <v-col>
                <div class="content-box">
                    ...
                    <p style="text-align: justify; text-justify: inter-word; font-size: 16px;">
                        대전 동구 중동에 위치한 '왕관식당'입니다. 하루에 두 시간만 운영되는 곳으로 매스컴에도 여러 번 소개되어 대전뿐만 아니라 전국에서도 유명한 곳입니다. 콩나물이 섞인 밥에 국내산
                        한우 암소로 만든 육회를 취향에 맞게 비벼 먹거나 따로 먹으면 됩니다. 가격이 저렴해서 점심 식사로 방문하기에 좋은 곳입니다. 예약, 포장 모두 불가능합니다.
                    </p>
                </div>
            </v-col>
            <v-col>
                <div class="content-box"><br>
                    <h3>영업시간　　　<span class="light-text">매일12:00 ~ 14:00</span></h3><br>
                    <h3>주소　　　　　
                        <span class="light-text">대전광역시 동구 선화로196번길 6</span>
                    </h3><br>
                    <div style="display: flex; align-items: center;">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <div
                        ...
                        <h5 style="display: inline-block; margin-left: 5px; color: grey;">대전광역시 동구 중동 3-30</h5>
                    </div><br>
                    <h3>전화번호　　　<span class="light-text">042-221-1663</span></h3><br>
                </div>
            </v-col>
        </v-row>
    </div>
...
export default {
    data() {
        return {
            ...
            current: 0,
            imageSources: [
                "https://img.siksinhot.com/place/1464571961377559.png?w=307&h=300&c=Y",
                "https://img.siksinhot.com/story/1506311675046451.jpg?w=307&h=300&c=Y",
                "https://img.siksinhot.com/insta/1445506257688037.jpg?w=307&h=300&c=Y",
                "https://img.siksinhot.com/story/1506311678014453.jpg?w=307&h=300&c=Y"
            ]
        };
    },
    mounted() {
