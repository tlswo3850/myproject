<template>
    <div id="app">
        ...
        <div style="display: flex; align-items: center;">
            ...
            <h1 class="custom-heading" style="font-size: 3rem;">성심당 본점</h1>&nbsp;
        ...
        <div style="display: flex; align-items: center;">
            ...
            <img src="data:image/png;base64,"
                style="width: 20px; height: 20px; margin-right: 5px;">
            <p class="custom-heading" style="font-size: 12px; margin-bottom: 0;">101</p>&nbsp;&nbsp;
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYojtp98XI0qyv4sKILEgHfAg1E1D4g8ZP1Q&usqp=CAU"
                style="width: 20px; height: 20px; margin-right: 5px;">
            <p class="custom-heading" style="font-size: 12px; margin-bottom: 0;">76</p>&nbsp;&nbsp;
        </div>
        <h3>
        ...
        <v-row>
            ...
            <v-col>
                <div class="content-box"><br>
                    <h3>영업시간　　　<span class="light-text">일,금,토08:00 ~ 23:00</span></h3>
                    <h3 class="light-text">　　　　　　　월,화,수,목08:00 ~ 22:00</h3><br><br>
                    <h3>주소　　　　　
                        <span class="light-text">대전광역시 중구 대종로480번길 15</span>
                    </h3><br>
                    <div style="display: flex; align-items: center;">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <div
                        ...
                        <h5 style="display: inline-block; margin-left: 5px; color: grey;">대전광역시 중구 은행동 145-1</h5>
                    </div><br>
                    <h3>전화번호　　　<span class="light-text">1588-8069</span></h3><br>
                </div>
            </v-col>
        </v-row>
    </div>
...
export default {
    data() {
        return {
            ...
            current: 0,
            imageSources: [
                "https://img.siksinhot.com/place/1536044069621434.jpg?w=307&h=300&c=Y",
                "https://img.siksinhot.com/story/1541393281663110.jpg?w=307&h=300&c=Y",
                "https://img.siksinhot.com/story/1536579815765325.jpeg?w=307&h=300&c=Y",
                "https://img.siksinhot.com/story/1533905762521379.JPG?w=307&h=300&c=Y"
            ]
        };
    },
    mounted() {
