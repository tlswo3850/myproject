<template>
    <div id="app">
        ...
        <div style="display: flex; align-items: center;">
            ...
            <h1 class="custom-heading" style="font-size: 3rem;">알로하녹</h1>&nbsp;
        ...
        <div style="display: flex; align-items: center;">
            ...
            <img src="data:image/png;base64,"
                style="width: 20px; height: 20px; margin-right: 5px;">
            <p class="custom-heading" style="font-size: 12px; margin-bottom: 0;">1</p>&nbsp;&nbsp;
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYojtp98XI0qyv4sKILEgHfAg1E1D4g8ZP1Q&usqp=CAU"
                style="width: 20px; height: 20px; margin-right: 5px;">
            <p class="custom-heading" style="font-size: 12px; margin-bottom: 0;">2</p>&nbsp;&nbsp;
        </div>
        <h3>
            ...
            <v-col>
                <div class="content-box">
                    ...
                    <p style="text-align: justify; text-justify: inter-word; font-size: 16px;">
                        요즘 sns를 강타하고 있는 선회동 카페 알로하녹입니다. 외관도 이쁘고 음식들도 맛은 기본 예쁘게 플레이팅 되어서 최근 커플과 친구들끼리 많이 찾습니다.
                        인절미스콘 같은 경우에는 나오는 시간이 정해져 있습니다.
                        커피와 과일음료 디저트류를 주로 판매하고 있습니다.
                    </p>
                </div>
            </v-col>
            <v-col>
                <div class="content-box"><br>
                    <h3>영업시간　　　<span class="light-text">매일12:00 ~ 22:00</span></h3><br>
                    <h3>주소　　　　　
                        <span class="light-text">대전광역시 중구 대종로521번길 29</span>
                    </h3><br>
                    <div style="display: flex; align-items: center;">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <div
                        ...
                        <h5 style="display: inline-block; margin-left: 5px; color: grey;">대전광역시 중구 선화동 236-8</h5>
                    </div><br>
                    <h3>전화번호　　　<span class="light-text">070-7799-2368</span></h3><br>
                </div>
            </v-col>
        </v-row>
    </div>
...
export default {
    data() {
        return {
            ...
            current: 0,
            imageSources: [
                "https://img.siksinhot.com/place/1511311080726180.jpg?w=307&h=300&c=Y",
                "https://img.siksinhot.com/place/1511311103260131.jpg?w=307&h=300&c=Y",
                "https://img.siksinhot.com/place/1511311114256182.jpg?w=307&h=300&c=Y",
                "https://img.siksinhot.com/place/1511311091342130.jpg?w=307&h=300&c=Y"
            ]
        };
    },
    mounted() {
