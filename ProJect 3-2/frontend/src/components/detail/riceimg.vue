<template>
    <div id="app">
        ...
        <div style="display: flex; align-items: center;">
            ...
            <h1 class="custom-heading" style="font-size: 3rem;">바로 그 집</h1>&nbsp;
        ...
        <div style="display: flex; align-items: center;">
            ...
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYojtp98XI0qyv4sKILEgHfAg1E1D4g8ZP1Q&usqp=CAU"
                style="width: 20px; height: 20px; margin-right: 5px;">
            <p class="custom-heading" style="font-size: 12px; margin-bottom: 0;">51</p>&nbsp;&nbsp;
        </div>
        <h3>
            ...
            <v-col>
                <div class="content-box">
                    ...
                    <p style="text-align: justify; text-justify: inter-word; font-size: 16px;">
                        대전 중앙로 지하상가에 있는 '바로그집'.
                        마요네즈로 만든 부드러운 소스로 '아이스크림 떡볶이'라는 별명을 얻게 된 맛집입니다.
                        이곳의 대표 메뉴 '모듬 떡볶이'는 떡과 김말이, 어묵으로 구성되어 있으며 달달하고 고소한 맛이 일품입니다.
                        고소한 김밥에 떡볶이 소스를 곁들여 먹는 것도 색다른 맛을 선사합니다.
                    </p>
                </div>
            </v-col>
            <v-col>
                <div class="content-box"><br>
                    <h3>영업시간　　　<span class="light-text"> 매일11:00 ~ 21:30</span></h3><br>
                    <h3>주소　　　　　
                        <span class="light-text">대전광역시 중구 중앙로 145 지하상가 C나 61호</span>
                    </h3><br>
                    <div style="display: flex; align-items: center;">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <div
                        ...
                        <h5 style="display: inline-block; margin-left: 5px; color: grey;">대전 중구 대흥동 630 지하상가 C나 61호</h5>
                    </div><br>
                    <h3>전화번호　　　<span class="light-text">
                            042-254-8925</span></h3><br>
                </div>
            </v-col>
        </v-row>
    </div>
...
export default {
    data() {
        return {
            ...
            current: 0,
            imageSources: [
                "https://img.siksinhot.com/place/1590631878301943.jpeg?w=307&h=300&c=Y",
                "https://img.siksinhot.com/place/1590631769965938.jpeg?w=307&h=300&c=Y",
                "https://img.siksinhot.com/place/1590631747313937.jpeg?w=307&h=300&c=Y",
                "https://img.siksinhot.com/place/1590631706035936.jpg?w=307&h=300&c=Y"
            ]
        };
    },
    mounted() {
