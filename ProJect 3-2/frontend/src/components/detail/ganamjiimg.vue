<template>
    <div id="app">
        ...
        <div style="display: flex; align-items: center;">
            ...
            <h1 class="custom-heading" style="font-size: 3rem;">가남지</h1>&nbsp;
        ...
        <div style="display: flex; align-items: center;">
            ...
            <img src="data:image/png;base64,"
                style="width: 20px; height: 20px; margin-right: 5px;">
            <p class="custom-heading" style="font-size: 12px; margin-bottom: 0;">22</p>&nbsp;&nbsp;
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYojtp98XI0qyv4sKILEgHfAg1E1D4g8ZP1Q&usqp=CAU"
                style="width: 20px; height: 20px; margin-right: 5px;">
            <p class="custom-heading" style="font-size: 12px; margin-bottom: 0;">12</p>&nbsp;&nbsp;
        </div>
        <h3>
        ...
        <v-row>
            <v-col>
                <div class="content-box">
                    ...
                    <p style="text-align: justify; text-justify: inter-word; font-size: 16px;">
                        대전에서 쌀국수 맛있기로 소문난 도룡동 맛집입니다.
                        맑은 육수의 닭쌀국수가 메인이며 돈까스 쌀국수, 코코넛 해물커리, 케슈넛 양념치킨 등의 퓨전 메뉴들도 별미입니다.
                        예약은 3인 이상 가능합니다.
                    </p>
                </div>
            </v-col>
            <v-col>
                <div class="content-box"><br>
                    ...
                    <h3>주소　　　　　
                        <span class="light-text">대전광역시 유성구 대덕대로 588</span>
                    </h3><br>
                    <div style="display: flex; align-items: center;">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <div
                        ...
                        <h5 style="display: inline-block; margin-left: 5px; color: grey;">대전광역시 유성구 도룡동 395-1</h5>
                    </div><br>
                    <h3>전화번호　　　<span class="light-text">042-861-7557</span></h3><br>
                </div>
            </v-col>
        </v-row>
    </div>
...
export default {
    data() {
        return {
            ...
            current: 0,
            imageSources: [
                "https://img.siksinhot.com/place/1675994382900282.jpg?w=307&h=300&c=Y",
                "https://img.siksinhot.com/place/1458874974654970.jpg?w=307&h=300&c=Y",
                "https://img.siksinhot.com/place/1458874974652969.jpg?w=307&h=300&c=Y",
                "https://img.siksinhot.com/place/1458874974651968.jpg?w=307&h=300&c=Y"
            ]
        };
    },
    mounted() {
